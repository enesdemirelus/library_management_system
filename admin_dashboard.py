...
class adminDashboard(tk.Tk):
    ...
    def creating_widgets(self):
        ...
        self.add_book_button = ttk.Button(self, text="Add Book", style="Medium.TButton", command= self.add_book)
        self.request_book_button = ttk.Button(self, text="Request a book back", style="Medium.TButton", command= self.request_book)
        self.all_book_button = ttk.Button(self, text="See all the books in the library", style="Medium.TButton", command= self.all_books)
